  ...
  return (
    <section className="pt-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 className="text-5xl md:text-6xl font-light mb-12 text-gray-900 pt-8">Frequently Asked Questions</h1>

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
          {/* Left: large image */}
          <div>
            <div className="relative w-full h-[420px] overflow-hidden rounded-sm">
              <Image src="/hero-bg.jpg" alt="faq" fill className="object-cover" />
            </div>
          </div>
